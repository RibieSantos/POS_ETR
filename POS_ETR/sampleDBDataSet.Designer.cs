...
namespace POS_ETR.sampleDBDataSetTableAdapters {
    ...
    public partial class UserTblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserTbl] WHERE (([user_id] = @Original_user_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserTbl] ([username], [password]) VALUES (@username, @password" +
                ");\r\nSELECT user_id, username, password FROM UserTbl WHERE (user_id = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[UserTbl] SET [username] = @username, [password] = @password WHERE (" +
                "([user_id] = @Original_user_id));\r\nSELECT user_id, username, password FROM UserT" +
                "bl WHERE (user_id = @user_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_id, username, password FROM dbo.UserTbl";
        ...
        public virtual int Fill(sampleDBDataSet.UserTblDataTable dataTable) {
        ...
        public virtual sampleDBDataSet.UserTblDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            sampleDBDataSet.UserTblDataTable dataTable = new sampleDBDataSet.UserTblDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(sampleDBDataSet.UserTblDataTable dataTable) {
